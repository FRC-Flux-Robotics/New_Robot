...
public final class DrivetrainConfig {
  ...
  public final PIDGains simSteerGains;
  public final PIDGains simDriveGains;
  public final PIDGains activeSteerGains;
  public final PIDGains activeDriveGains;
  ...
  public final VisionConfig visionConfig;
  ...
  private DrivetrainConfig(Builder b, boolean isSimulation) {
    ...
    this.simSteerGains = b.simSteerGains;
    this.simDriveGains = b.simDriveGains;
    this.activeSteerGains =
        (isSimulation && b.simSteerGains != null) ? b.simSteerGains : b.steerGains;
    this.activeDriveGains =
        (isSimulation && b.simDriveGains != null) ? b.simDriveGains : b.driveGains;
    ...
    this.diagnosticsConfig =
        b.diagnosticsConfig != null ? b.diagnosticsConfig : DiagnosticsConfig.defaults();
  ...
  public SwerveDrivetrainConstants toSwerveDrivetrainConstants() {
    return new SwerveDrivetrainConstants().withCANBusName(canBus).withPigeon2Id(pigeonId);
  }
  ...
  /** Maximum distance from robot center to any module position (meters). */
  public double driveBaseRadius() {
    double maxDist = 0;
    for (ModuleConfig module : new ModuleConfig[] {frontLeft, frontRight, backLeft, backRight}) {
      double dist = Math.hypot(module.xPositionMeters, module.yPositionMeters);
  ...
  private Translation2d modulePosition(ModuleConfig module) {
    return new Translation2d(Meters.of(module.xPositionMeters), Meters.of(module.yPositionMeters));
  }
  ...
  public SwerveModuleConstantsFactory<
    ...
    return new SwerveModuleConstantsFactory<
        ...
        .withSteerMotorGains(activeSteerGains.toSlot0Configs())
        .withDriveMotorGains(activeDriveGains.toSlot0Configs())
  ...
  public static final class Builder {
    ...
    private PIDGains simSteerGains;
    private PIDGains simDriveGains;
    ...
    public Builder simSteerPID(PIDGains gains) {
      this.simSteerGains = gains;
      return this;
    }

    public Builder simDrivePID(PIDGains gains) {
      this.simDriveGains = gains;
      return this;
    }
    ...
    public Builder autoDrive(AutoDriveConfig autoDrive) {
      this.autoDrive = autoDrive;
      return this;
    }

    public Builder visionConfig(VisionConfig visionConfig) {
      this.visionConfig = visionConfig;
      return this;
    }

    public Builder diagnosticsConfig(DiagnosticsConfig diagnosticsConfig) {
    ...
    public Builder deadband(double translation, double rotation) {
      ...
      if (rotation < 0 || rotation > 1) {
        throw new IllegalArgumentException("rotationDeadband must be 0.0-1.0, got: " + rotation);
      }
    ...
    public DrivetrainConfig build() {
      return build(RobotBase.isSimulation());
    }

    DrivetrainConfig build(boolean isSimulation) {
      ...
      return new DrivetrainConfig(this, isSimulation);
    }
