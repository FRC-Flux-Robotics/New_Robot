...
final class InputProcessing {
  ...
  /**
   * Applies an expo input curve with sign preservation. Values below the deadband threshold return
   * zero to prevent drift.
   *
  ...
  /**
   * Clamps a 2D stick vector to unit magnitude. If the magnitude exceeds 1.0, the vector is
   * normalized. Otherwise it is returned unchanged.
   *
