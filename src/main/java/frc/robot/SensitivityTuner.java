 ...
 *
 * <p>Parameters are published to SmartDashboard on construction and read back on each transfer()
 * call, allowing real-time adjustment during testing.
 */
public class SensitivityTuner {
   ...
   *
   * @param prefix SmartDashboard key prefix (e.g., "Drive_" for translation, "Rot_" for rotation)
   ...
   */
  public SensitivityTuner(
      String prefix, double xStart, double xMiddle, double yStart, double yMiddle, double yMax) {
    this.prefix = prefix;
    this.xStart = xStart;
