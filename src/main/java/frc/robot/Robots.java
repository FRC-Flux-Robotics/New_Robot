...
/**
 * Static DrivetrainConfig instances for each robot. Values sourced from CTRE Tuner X measurements
 * (PID, gearing) and mechanical specs (CAN IDs, positions).
 */
      ...
      DrivetrainConfig.builder()
          ...
          .frontLeft(
              new ModuleConfig(
                  ...
                  8, /* encoder */
                  23,
                  /* offset */ 0.124267578125, /* x */
                  0.2921, /* y */
                  0.2921,
                  /* invDrive */ false, /* invSteer */
                  false, /* invEnc */
                  false))
          .frontRight(
              new ModuleConfig(
                  ...
                  2, /* encoder */
                  20,
                  /* offset */ -0.291015625, /* x */
                  0.2921, /* y */
                  -0.2921,
                  /* invDrive */ true, /* invSteer */
                  false, /* invEnc */
                  false))
          .backLeft(
              new ModuleConfig(
